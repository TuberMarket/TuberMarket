...
#     st.write(f"**Company Name:** {stock_info.get('longName')}")
#     st.write(f"**Sector:** {stock_info.get('sector')}")
#     st.write(f"**Country:** {stock_info.get('country')}")
#     st.write(f"**Website:** {stock_info.get('website')}")
#     st.write(f"**Market Cap:** {stock_info.get('marketCap')}")
#     st.write(f"**Stock Price:** {stock_info.get('regularMarketPrice')}")
